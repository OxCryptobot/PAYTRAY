...
The safest remaining engineering order is **target evidence for AU/AV/AX/BC/AY/BA/BI/BL/BM/BN/BO/BP → worker deployment and durable-hook target verification → scheduled idempotency housekeeping in the target host**, while **BE remains intentionally deferred**.
