...
| DK | CI required-check artifact contract | Pushed | `8b193a3`; the redacted matrix verifier accepts required check names and the release-gate artifact step requires `secret-manager-custody`; remote CI passed all five jobs. |
