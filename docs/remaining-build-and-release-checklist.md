...
| CO | Detached evidence-bundle integrity verification | Validated locally | `backend:ops:evidence:bundle:verify` recomputes the canonical SHA-256 fingerprint, normalizes PostgreSQL timestamps, rejects tampering and safety-field changes, and verifies blocked artifacts without granting release or settlement authority. |
